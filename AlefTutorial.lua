if getgenv().hub then warn("DraxHub : Already executed!") return end
getgenv().hub = true
...
local Window = Fluent:CreateWindow({
    ...
    SubTitle = " (discord.gg/xXTZj8c2)", -- discord link
    TabWidth = 160,
...
do
    Tabs.Home:AddButton({
        ...
        Callback = function()
            setclipboard("https://discord.gg/xXTZj8c2") -- discord link
        end
    })
